...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    <artifactId>spring-boot-demo-kafka-websocket</artifactId>
    <version>1.0.0-SNAPSHOT</version>

    <name>spring-boot-demo-kafka-websocket</name>
    ...
    <build>
        <finalName>spring-boot-demo-kafka-websocket</finalName>
        <plugins>
            <plugin>
                <groupId>org.springframework.boot</groupId>
...
> 此部分实体 参见包路径 [com.zzzzzzzs.websocket.model](src/main/java/com/zzzzzzzs/kafka/websocket/model)
